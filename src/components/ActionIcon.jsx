...
// Stroke UI icons for the mobile action bar, 24px grid, one consistent style.
const PATHS = {
  // Apple-style settings gear (Feather "settings" cog)
  settings: (
    <>
  ...
  undo: <><path d="M8 7 3 12l5 5" /><path d="M3 12h11a5 5 0 0 1 5 5v1" /></>,
